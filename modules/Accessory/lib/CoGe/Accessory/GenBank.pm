...
__PACKAGE__->mk_accessors qw(id locus accn length moltype division date definition verison keywords source organism sequence srcfile dir anntoation features);
