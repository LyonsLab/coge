...
sub build {
	...
	#my $dot_xy_path = $self->params->{ksfile_xy};
	#my $dot_xz_path = $self->params->{ksfile_xz};
	#my $dot_yz_path = $self->params->{ksfile_yz};
	...
	print STDERR "ARE WE HERE YET?!?!?!";
	#print STDERR Dumper($merge_o);
