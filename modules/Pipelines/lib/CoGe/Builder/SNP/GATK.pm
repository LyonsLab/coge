...
sub generate_additional_metadata {
    ...
    push @annotations, qq{note|SNPs generated using GATK method, -stand_call_conf=$stand_call_conf -stand_emit_conf=$stand_emit_conf $filter_reads_with_N_cigar $fix_misencoded_quality_scores realign=$realign};
    return \@annotations;
}
