...
sub generate_additional_metadata {
    ...
    push @annotations, qq{note|SNPs generated using GATK method --emitRefConfidence $emitRefConfidence --pcr_indel_model $pcr_indel_model $filter_reads_with_N_cigar $fix_misencoded_quality_scores realign=$realign};
    return \@annotations;
}
