package CoGeX::Result::GenomeAnnotation;
...
CoGeX::GenomeAnnotation

=head1 SYNOPSIS

This object uses the DBIx::Class to define an interface to the C<genome_annotation> table in the CoGe database.

=head1 DESCRIPTION

Object for interacting with the Genome Annotations table in the CoGe database.
...
__PACKAGE__->table("genome_annotation");
