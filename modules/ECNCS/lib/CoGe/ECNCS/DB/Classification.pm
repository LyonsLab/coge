package CoGe::ECNCS::DB::Classification;
use strict;
...
BEGIN {
    ...
    __PACKAGE__->columns(All=>qw(classification_id name description));
...
CoGe::ECNCS::DB::classification - CoGe::ECNCS::DB::classification
