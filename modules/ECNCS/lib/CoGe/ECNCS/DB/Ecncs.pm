...
BEGIN {
    ...
    @EXPORT_OK   = qw();
    %EXPORT_TAGS = ();
    __PACKAGE__->table('ecncs');
    __PACKAGE__->columns(All=>qw(ecncs_id algorithm_run_id location_id name pval alignment similarity identity note valid));
