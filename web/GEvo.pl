...
sub gen_params
  {
	...
	$params .= qq{'args__draccn$i', 'args__'+encodeURIComponent(document.getElementById('accn$i').value),};#qq{'args__draccn$i', 'accn$i',}; # mdb changed 10/9/12 issue #11
