define( [
    ...
    function(
        ...
        Layout,
        Location) {
            var cogeFeatures = declare( [ BlockBased, YScaleMixin, ExportMixin, FeatureDetailMixin ], {
                /**
                ...
                toggle: function(label, enter) {
                    ...
                    var other_side = document.querySelectorAll('.feature-label' + (plus ? '.coge-minus' : '.coge-plus'));
                ...
                updateFeatureLabelPositions: function( coords ) {
                    ...
                    dojo.query( '.coge-feature', block.domNode )
                ...
                fillBlock: function( args ) {
                    ...
                    this.store.getGlobalStats(
                            ...
                            seperatorDiv = '<div class="coge-gene-seperation"></div>'
                 ...
                 */
                addFeatureToBlock: function( feature, uniqueId, block, scale, labelScale, descriptionScale, containerStart, containerEnd ) {
                ...
                */
                ...
                measureStyles: function() {
                    ...
                    heightTest.className =
                        "coge-feature " + this.config.style.className
                ...
                renderFeature: function( feature, uniqueId, block, scale, labelScale, descriptionScale, containerStart, containerEnd ) {
                    ...
                    wideTypes = ["CDS", "rRNA", "tRNA"];
                    function isType(list) { return list.indexOf(featType) !== -1 ? true : false; }

                    if(isType(types)) {
                        if (isType(geneTypes)) {
                            top += 8;
                        } else if (!isType(wideTypes)) {
                            top += 5;
                        }
                    } else {
                        top -= 6;
