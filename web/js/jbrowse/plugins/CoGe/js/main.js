...
return declare( JBrowsePlugin,
{
	constructor: function( args ) {
		...
		// --- replace JBrowse function to prevent changing zoom when changing chromosomes ---
	...
	// copy of JBrowse function needed for navigateToLocation above
	...
	create_find_features_button: function() {
		new Button({
			...
			title: 'Search for features by name and type'
