...
Dom = {
   ...
   getXY : function(el) {
      ...
      if (el.parentNode === null || Dom.getStyle(el, 'display') == 'none') {
         return false;
      }
      ...
      if (el.getBoundingClientRect) { // IE
         ...
         if (
            ua.indexOf('opera') != -1
            || ( ua.indexOf('safari') != -1 && Dom.getStyle(el, 'position') == 'absolute' )
         ) {
