...
//	var mp_x = local_event.clientX - can_elemt.offsetLeft + window.pageXOffset;
//	var mp_y = local_event.clientY - can_elemt.offsetTop + window.pageYOffset;
...
//	readout_elemt.innerHTML = "X:"+mp_x+", Y:"+mp_y+"<br>Link: '"+list_output[0]+"'<br>OnMouseMove: '"+list_output[1]+"'";
	if (list_output != [])	//Make sure the list isn't empty
	{
