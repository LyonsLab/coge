	...
	my @actions = (
		{
			...
			NAME => qq{<span style="display:inline-block;width:100px;">GEvo</span><span style="font-weight:normal;">High-resolution sequence analysis of genomic regions</span>},
		},
		{
			ID   => 3,
			...
			NAME => qq{<span style="display:inline-block;width:100px;">FeatView</span><span style="font-weight:normal;">Search for genomic features by name</span>},
		},
...
# 		   },
		{
			...
			NAME => qq{<span style="display:inline-block;width:100px;">OrganismView</span><span style="font-weight:normal;">Search for organisms and perform analyses on their genomes</span>},
		},
		{
			ID   => 2,
			...
			NAME => qq{<span style="display:inline-block;width:100px;">CoGeBlast</span><span style="font-weight:normal;">Blast sequences against any number of genomes of your choosing</span>},
		},
...
# 		   }
		{
			...
			NAME => qq{<span style="display:inline-block;width:100px;">SynMap</span><span style="font-weight:normal;">Whole genome syntenic dotplot anlayses</span>},
		},
		{
			ID   => 4,
			...
			NAME => qq{<span style="display:inline-block;width:100px;">SynFind</span><span style="font-weight:normal;">Identify syntenic regions across many genomes</span>},
		},
	);
	return \@actions;
}
