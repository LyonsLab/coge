IMpreload('Homepage_files', 'shapeimage_2', '0');
IMpreload('Homepage_files', 'shapeimage_2', '1');
IMpreload('Homepage_files', 'shapeimage_2', '2');
IMpreload('Homepage_files', 'shapeimage_2', '3');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupAllIEPNGBGs();
    fixupIEPNG("shapeimage_2_link_0", "Homepage_files/transparent.gif");
    fixupIEPNG("shapeimage_2_link_1", "Homepage_files/transparent.gif");
    fixupIEPNG("shapeimage_2_link_2", "Homepage_files/transparent.gif");
    fixupIEPNG("shapeimage_2_link_3", "Homepage_files/transparent.gif");
    fixupIEPNG("shapeimage_2", "Homepage_files/transparent.gif");
    return true;
}
