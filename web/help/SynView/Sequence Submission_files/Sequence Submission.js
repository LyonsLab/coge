...
function onPageLoad()
{
    ...
    fixupIEPNG("id7", "Sequence Submission_files/transparent.gif");
    fixupIEPNG("id8", "Sequence Submission_files/transparent.gif");
    fixupIEPNG("id9", "Sequence Submission_files/transparent.gif");
    fixupIEPNG("id10", "Sequence Submission_files/transparent.gif");
    fixupIEPNG("id11", "Sequence Submission_files/transparent.gif");
    fixupIEPNG("id12", "Sequence Submission_files/transparent.gif");
    fixupIEPNG("id16", "Sequence Submission_files/transparent.gif");
    fixupIEPNG("id17", "Sequence Submission_files/transparent.gif");
    return true;
}
