IMpreload('Welcome_files', 'shapeimage_16', '0');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupIEPNG("id14", "Welcome_files/transparent.gif");
    fixupIEPNG("id15", "Welcome_files/transparent.gif");
    fixupIEPNG("id16", "Welcome_files/transparent.gif");
    fixupIEPNG("id17", "Welcome_files/transparent.gif");
    fixupIEPNG("id18", "Welcome_files/transparent.gif");
    fixupIEPNG("id19", "Welcome_files/transparent.gif");
    fixupIEPNG("id20", "Welcome_files/transparent.gif");
    fixupIEPNG("shapeimage_16_link_0", "Welcome_files/transparent.gif");
    fixupIEPNG("shapeimage_16", "Welcome_files/transparent.gif");
    ...
    fixupIEPNG("id41", "Welcome_files/transparent.gif");
    fixupIEPNG("id42", "Welcome_files/transparent.gif");
    fixupIEPNG("id43", "Welcome_files/transparent.gif");
    fixupIEPNG("id44", "Welcome_files/transparent.gif");
    fixupIEPNG("id45", "Welcome_files/transparent.gif");
    fixupIEPNG("id46", "Welcome_files/transparent.gif");
    fixupIEPNG("id47", "Welcome_files/transparent.gif");
    fixupIEPNG("id48", "Welcome_files/transparent.gif");
    ...
    fixupIEPNG("id65", "Welcome_files/transparent.gif");
    fixupIEPNG("id66", "Welcome_files/transparent.gif");
    fixupIEPNG("id67", "Welcome_files/transparent.gif");
    fixupIEPNG("id68", "Welcome_files/transparent.gif");
    fixupIEPNG("id69", "Welcome_files/transparent.gif");
    fixupIEPNG("id70", "Welcome_files/transparent.gif");
