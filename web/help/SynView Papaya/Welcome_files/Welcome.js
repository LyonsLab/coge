IMpreload('Welcome_files', 'shapeimage_20', '0');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupIEPNG("shapeimage_20_link_0", "Welcome_files/transparent.gif");
    fixupIEPNG("shapeimage_20", "Welcome_files/transparent.gif");
    fixupIEPNG("id31", "Welcome_files/transparent.gif");
    fixupIEPNG("id32", "Welcome_files/transparent.gif");
    ...
    fixupIEPNG("id93", "Welcome_files/transparent.gif");
    return true;
}
