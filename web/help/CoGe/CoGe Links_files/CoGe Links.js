...
function onPageLoad()
{
    ...
    fixupAllIEPNGBGs();
    fixupIEPNG("id2", "CoGe Links_files/transparent.gif");
    fixupIEPNG("id5", "CoGe Links_files/transparent.gif");
    fixupIEPNG("id8", "CoGe Links_files/transparent.gif");
    fixupIEPNG("id9", "CoGe Links_files/transparent.gif");
    fixupIEPNG("id11", "CoGe Links_files/transparent.gif");
    return true;
}
