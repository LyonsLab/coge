...
def gc_features(environ, start_response):
    ...
    try:
        ...
        string = fetch_sequence(genome_id, chr_id, start+1, end+1, None)
                #environ['HTTP_COOKIE']) # mdb removed 12/11/14 to get this track to work in Sean Davey's (GEISHA project) JBrowse instance
