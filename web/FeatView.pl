...
sub get_anno
  {
	...
	$anno .= qq{<DIV id="dnaseq$i"><input type="button" value = "Click for DNA sequence" onClick="window.open('SeqView.pl?featid=$featid&dsid=$ds&chr=$chr&name=$accn&rc=$rc&pro=$pro','window', 'menubar=1, resizable=1, scrollbars=1, location=1,left=20, top=20, width=700, height=610');"></DIV>};
